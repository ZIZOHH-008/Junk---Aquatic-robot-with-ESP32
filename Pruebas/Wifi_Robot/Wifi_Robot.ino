 ...
 * Connect to AP "Robot Wifi", password = "12345678"
 */
...
if( server.hasArg("State") ){
  ...
  server.send ( 200, "text/html", "" );  //Enviar estado HTTP 200 (Ok) y enviar texto al navegador/cliente
  delay(1);
}
...
void goForwardRight(){
//      Serial.println("Adelante_Derecha");
      digitalWrite(IN_1, HIGH);
      digitalWrite(IN_2, LOW);
...
void goForwardLeft(){
//      Serial.println("Adelante_Izquierda");
      digitalWrite(IN_1, HIGH);
      digitalWrite(IN_2, LOW);
      analogWrite(ENA, speedCar);
